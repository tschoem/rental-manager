...
export default function RoomCard({ room, propertyImages = [] }: RoomCardProps) {
  ...
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 'var(--card-radius, 12px)', overflow: 'hidden', background: 'white' }}>
      {/* Image Gallery */}
      ...
      <div style={{ padding: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', flexWrap: 'wrap', gap: '1rem', marginBottom: '1rem' }}>
          <div style={{ flex: 1 }}>
            <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', textAlign: 'left' }}>{room.name}</h3>
